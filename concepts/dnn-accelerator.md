...
### 연산 절감 기법
- **SnaPEA**: CNN의 ReLU 특성을 활용한 조기 활성화 — Exact mode에서 평균 28% speedup, 16% energy 절감 (정확도 손실 0%), Predictive mode에서 3% 정확도 손실로 최대 3.59× speedup ([paper-summaries/2018ISCA-summarize/snapea-predictive-early-activation-for-reducing-computation-in-deep-convolutional-neural-networks.md])
